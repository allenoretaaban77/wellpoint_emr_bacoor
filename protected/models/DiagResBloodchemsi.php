...
/**
 * This is the model class for table "diag_res_bloodchemsi".
 *
 * The followings are the available columns in table 'diag_res_bloodchemsi':
 * @property string $id
 ...
 * @property string $creatinine_clearance
 * @property string `$alkaline_phosphatase`
 * @property text $other
 */
class DiagResBloodchemsi extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('sp_no, patient_name, req_doctor, read_doctor, medtech, pathologist, glucose, bun, creatinine, uric_acid, cholesterol, triglycerides, hdl_c, ldl_c, vldl_c, sgot_ast, sgpt_alt, hba1c, total_bilirubin, direct_bilirubin, indirect_bilirubin, sodium, potassium, chloride, calcium, total_protein, creatinine_clearance, alkaline_phosphatase, other', 'length', 'max'=>250),
