...
class Patient extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
            ...
            array('positionapplyingfor, comments', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, code, firstname, lastname, middleinitial, gender, birthdate, civilstatus, street1, street2, barangay, city, province, occupation, company, spousename, spouseoccupation, emergencycontactname, emergencycontactrelation, emergencycontactaddress, emergencycontactnos, positionapplyingfor, comments', 'safe', 'on'=>'search'),
		);
	}
