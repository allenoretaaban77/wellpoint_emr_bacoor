...
class Dailysheetform extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('beginningcash, beginningpaymaya, beginning_gcash, beginning_bpi, beginning_ccg,cashdeposit, total', 'numerical'),
			array('supervisorname, verifiedby, preparedby', 'length', 'max'=>128),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, date, beginningcash, beginningpaymaya, beginning_gcash, beginning_bpi, beginning_ccg, supervisorname, denomination1000, denomination500, denomination200, denomination100, denomination50, denomination20, denomination10, denomination5, denomination1, denomination50c, denomination25c, denomination10c, denomination5c, denomination1c, cashcensus_laboratory, cashcensus_ancillary, cashcensus_consultation, hmocensus_laboratory, hmocensus_ancillary, hmocensus_consultation, cashdeposit, total, verifiedby, preparedby', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'beginning_ccg' => 'Beginning Credit Card / G-Cash',
	...
	public function search()
	{
		...
		$criteria->compare('beginning_ccg',$this->beginning_ccg);
