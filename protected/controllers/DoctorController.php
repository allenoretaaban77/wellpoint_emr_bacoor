...
class DoctorController extends RController
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Doctor']))
		{
            ...
            $model->image_signature = CUploadedFile::getInstance($model,'image_signature');
            if ($model->image_signature != null)
            {
                $model->signature = 'images/doctor/sign_'.$model->id.'.'.$model->image_signature->extensionName;
                $model->image_signature->saveAs($model->signature);
            } else
                $model->signature = 'images/noimage.png';
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Doctor']))
		{
            ...
            if ($model->image != null)
            {
                $model->filename = 'images/doctor/'.$model->id.'.'.$model->image->extensionName;
                $model->image->saveAs($model->filename);
            }
