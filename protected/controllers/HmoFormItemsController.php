...
class HmoFormItemsController extends RController
{
    ...
    public function printChargeslipItem($id)
    {
        ...
        //$rfid = 93;
        switch($rfid){
            case 5: //$string_image = "theena"; 
                $signature_size = "50px"; $signature_margin_bottom = "14px"; break;
            case 13: //$string_image = "joy"; 
                $signature_size = "50px"; $signature_margin_bottom = "18px"; break;
            case 41: //$string_image = "dianne"; 
                $signature_size = "60px"; $signature_margin_bottom = "12px"; break;
            case 67: //$string_image = "ruth"; 
                $signature_size = "60px"; $signature_margin_bottom = "20px"; break;
            case 94: //$string_image = "dj"; 
                $signature_size = "70px"; $signature_margin_bottom = "33px"; break;
            case 148: //$string_image = "yandy"; 
                $signature_size = "70px"; $signature_margin_bottom = "20px"; break;
            case 118: //$string_image = "janeth"; 
                $signature_size = "50px"; $signature_margin_bottom = "14px"; break;
            case 171: //$string_image = "elicka"; 
                $signature_size = "70px"; $signature_margin_bottom = "20px"; break;
            case 180: // cheriel
                $signature_size = "77px"; $signature_margin_bottom = "30px"; break;
            case 153: // marjorie
                $signature_size = "77px"; $signature_margin_bottom = "25px"; break;
            case 199: // merick
                $signature_size = "60px"; $signature_margin_bottom = "15px"; break;
            case 203: // ercalonia
                $signature_size = "26px"; $signature_margin_bottom = "9px"; break;
            case 204: // jarvie.wp
                $signature_size = "55px"; $signature_margin_bottom = "20px"; break;
            case 93: // floriano
                $signature_size = "35px"; $signature_margin_bottom = "10px"; break;
            default: 
                $signature_size = "26px"; $signature_margin_bottom = "9px"; break;
        }
        
        $signature = 'http://'.$_SERVER["HTTP_HOST"]."/images/billing_officer/$rfid.png";
