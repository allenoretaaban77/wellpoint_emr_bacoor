...
<fieldset>
    ...
    $this->widget('zii.widgets.jui.CJuiTabs', array(
            'tabs'=>array(
                ...
                'Blood Chemistry (Conventional)'=>$this->renderPartial('relation/_bloodchem', array('model'=>$model), $this),
                'Blood Chemistry (SI)'=>$this->renderPartial('relation/_bloodchemsi', array('model'=>$model), $this),
            ),
    ));
    ?>
</fieldset>
