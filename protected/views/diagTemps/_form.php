...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row">             
        ...
        Special Data Fill tags:</span><br/>        
        [patient_birthdate] = Patient Birthdate<br/>
        [patient_id] = Patient ID<br/>
        [user_personalname] = First Name and Last Name of current user<br/>
        [user_joblicenseno] = License No. of current user              <br/>        
        [date_released] = Date Result is Created<br/>
	...
	<div id="sidebar">
        <div class="portlet" id="yw0">
            <?php echo CHtml::submitButton($model->isNewRecord ? 'Create' : 'Save', array('class' => 'wp_button')); ?>
        </div>
    </div>
